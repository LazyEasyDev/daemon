...
scp "${ssh_options[@]}" "$build_dir/daemon" "$build_dir/test-app" "$build_dir/relative-path-test.txt" "$build_dir/guest-test.sh" "$build_dir/interpreted-app-test.sh" "$ssh_user@$ip_address:/tmp/"
