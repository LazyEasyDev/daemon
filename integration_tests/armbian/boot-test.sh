...
phase_file="$state_dir/armbian-phase"
result_file="$state_dir/armbian-result"
full_log="$state_dir/armbian-test.log"
phase_log="$state_dir/armbian-phase.log"
artifact_archive="$state_dir/armbian-artifacts.tar"
lock=/run/daemon-itest-boot.lock
