...
phase_file="$state_dir/gentoo-phase"
result_file="$state_dir/gentoo-result"
full_log="$state_dir/gentoo-test.log"
phase_log="$state_dir/gentoo-phase.log"
artifact_archive="$state_dir/gentoo-artifacts.tar"
