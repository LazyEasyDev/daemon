...
run_integration_test() {
	...
	phase_file="$state_dir/immortalwrt-phase"
	result_file="$state_dir/immortalwrt-result"
	full_log="$state_dir/immortalwrt-test.log"
	phase_log="$state_dir/immortalwrt-phase.log"
	artifact_archive="$state_dir/immortalwrt-artifacts.tar"
	...
	printf '[immortalwrt-boot] running %s\n' "$phase"
