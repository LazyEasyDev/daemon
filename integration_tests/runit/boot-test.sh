...
phase_file="$state_dir/void-phase"
result_file="$state_dir/void-result"
full_log="$state_dir/void-test.log"
phase_log="$state_dir/void-phase.log"
artifact_archive="$state_dir/void-artifacts.tar"
